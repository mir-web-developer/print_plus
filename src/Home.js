...
const Home = () => {
  ...
  const initialProducts = [
    {
      ...
      category: "Одежда",
      image:
        "https://drive.google.com/uc?export=view&id=1r-m826yAAUH745WIbgLaAO-QSbIIFwD5"
    },
    {
      id: 2,
      name: "Кружка",
      category: "Посуда",
      image:
        "https://drive.google.com/uc?export=view&id=1Wn1m6eIOtycR1RfjFIEzE5_qS8bDVEss"
    },
    {
      id: 3,
      name: "Подушка",
      category: "Декор",
      image:
        "https://drive.google.com/uc?export=view&id=1Sll3Zen2imd3XBEY0ZK4y0uHb6eK0zdO"
    },
    {
      id: 4,
      name: "Коробка",
      category: "Декор",
      image:
        "https://drive.google.com/uc?export=view&id=1uLpjanQz_DP3KVd8A3fyTWSoqc0i-E_C"
    },
    {
      id: 5,
      name: "Часы",
      category: "Декор",
      image:
        "https://drive.google.com/uc?export=view&id=1vmWyYhfL3gIPvejPnV-EPDf4Qu2hM9rk"
    },
    {
      id: 6,
      name: "Тарелка",
      category: "Декор",
      image:
        "https://drive.google.com/uc?export=view&id=1M6BJvGM2zDxAkQqSBP7yE9QJdzzTISBm"
    },
    {
      id: 7,
      name: "Рамка",
      category: "Декор",
      image:
        "https://drive.google.com/uc?export=view&id=1Wih49nRJafyXUYSFHHaD9VEQ0MF3Wjje"
    },
    {
      id: 8,
      name: "Шоколад",
      category: "Декор",
      image:
        "https://drive.google.com/uc?export=view&id=1tV29st24-s1M48Igl6s1MYmhMeOcHRbR"
    },
    {
      id: 9,
      name: "Украшение машины",
      category: "Декор",
      image:
        "https://drive.google.com/uc?export=view&id=1x1UHRw-R4lxegz-dWexdFCSDEZMV44q0"
    },
    {
      id: 10,
      name: "Брендовые вещи",
      category: "Декор",
      image:
        "https://drive.google.com/uc?export=view&id=19WrrEAZYgfy-xJfDPdKkdPX40E1o0JYu"
    },
    {
      id: 11,
      name: "Шарики",
      category: "Декор",
      image:
        "https://drive.google.com/uc?export=view&id=152C3m_LYCZMGugk19hZB98jc6Mz4g9m5"
    },
    {
      id: 12,
      name: "Другое",
      category: "Декор",
      image:
        "https://drive.google.com/uc?export=view&id=1L42PDxblBFG_R-6G_K7jfqZaAr59UwRN"
    }
  ];
  ...
  const categoryOptions = [
    ...
    { value: "Тарелка", label: "Тарелка" },
    { value: "Рамка", label: "Рамка" },
    { value: "Шоколад", label: "Шоколад" },
    { value: "Украшение машины", label: "Украшение машины" },
    { value: "Брендовые вещи", label: "Брендовые вещи" },
    { value: "Шарики", label: "Шарики" },
      ...
      <Dialog open={openOrderDialog} onClose={handleOrderDialogClose}>
        ...
        <DialogContent>
          ...
          <TextareaAutosize
            ...
            style={{ width: "95%", marginBottom: 16, padding: 8 }}
            required
          />
